// scripts/lib/beautyTreeData.mjs
// Shared source of truth for the Beauty 3-level category tree (7 departments
// → groups → leaves), in all four locales (tg / ru / en / fa). Used by:
//   - scripts/gen_beauty_tree.mjs        → migrations/12_beauty_category_tree.sql (one file)
//   - scripts/split_beauty_tree_sql.mjs  → migrations/12_parts/*.sql (one file per department)
// Edit the tree here — both generators read from this one place.
//
...
export const L = (slug, tg, ru, en, fa, children = null, icon = null) => ({ slug, tg, ru, en, fa, children, icon });
...
export const OLD_SLUGS = ["cleansers", "serums", "moisturizers", "suncare", "face-makeup", "lip-makeup", "eye-makeup", "fragrance", "brushes", "devices"];
