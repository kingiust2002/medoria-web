      ...
      >
        {sent ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-ink-muted mb-6 leading-relaxed">{t.quoteModal.sentSub}</p>
          ...
          <form onSubmit={handleSend} className="p-6 md:p-7">
            <div className="flex items-start justify-between mb-1.5">
              ...
              <button type="button" onClick={onClose} className="text-ink-faint hover:text-ink -mt-1 -mr-1 p-1">
            ...
            <div className="bg-tint-blue rounded-xl p-3 mb-5 border border-primary/10 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-ink-muted mt-0.5 tabular">${product.price} · {product.unit}</div>
              </div>
            </div>

            <div className="space-y-3">
              <div>
                <label className="block text-[11px] font-semibold text-ink mb-1">{t.quoteModal.name}</label>
            ...
            <button type="submit" className="btn-primary size-lg w-full mt-5">
