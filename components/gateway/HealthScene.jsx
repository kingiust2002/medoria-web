...
// Inline SVG + CSS only: layered frosted-glass modules of varying heights with
// surgical-silver lit edges, a vertical light shaft, a faint precision grid and a
// soft floor reflection. Abstract — no products. aria-hidden.
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div
        ...
        style={{ background: "radial-gradient(78% 58% at 50% 26%, rgba(47,111,230,0.10), transparent 70%)" }}
      />
      {/* vertical light shaft */}
      <div
        className="absolute left-1/2 top-0 h-2/3 w-40 -translate-x-1/2 blur-2xl"
        style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.9), transparent)" }}
      />
      <svg
        className="absolute left-1/2 top-[14%] w-[min(86%,560px)] -translate-x-1/2"
        viewBox="0 0 560 420"
        fill="none"
