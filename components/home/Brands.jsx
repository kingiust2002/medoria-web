...
const LABELS = {
  ru: { tag: "ПРОВЕРЕННЫЕ БРЕНДЫ", title: "С кем мы работаем" },
  tg: { tag: "БРЕНДҲОИ САНҶИДАШУДА", title: "Бо кӣ кор мекунем" },
  en: { tag: "TRUSTED BRANDS", title: "Brands we work with" },
  fa: { tag: "برندهای معتبر", title: "با چه برندهایی کار می‌کنیم" },
};

// Placeholder brand names — replace with real ones later
const BRANDS = [
  "MediCare", "SafeWear", "MedTech", "ClinicPro", "SteriLab", "VitaMed",
  "PureCare", "HealthFirst", "MediPlus", "BioShield",
];
