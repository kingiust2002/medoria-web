...
const COPY = {
  tg: {
    ...
    worlds: { tag: "ҲАФТ ҶАҲОН", title: "Интихоби касбии зебоӣ", items: [
      ["Атру атриёт", "Атри аслӣ, бӯи хона ва тӯҳфа — мардона, занона ва умумӣ."],
      ["Маҳсулоти беҳдоштӣ", "Нигоҳубини рӯй, бадан, даҳон ва кӯдак, инчунин маҷмӯаҳои риштарошӣ ва беҳдоштӣ."],
      ["Маҳсулоти ороишӣ", "Асосҳои ранг ва тарҳи рӯй, интихобшуда барои ҳунар, иҷро ва пешниҳод."],
      ["Нигоҳубини мӯй", "Нигоҳубин, шаклдиҳӣ ва рангкунӣ — аз касбии салон то ҳаррӯза."],
      ["Абзори барқӣ", "Мошинка, фен, оҳани шаклдиҳӣ ва дастгоҳҳои нигоҳубини шахсӣ."],
      ["Аксессуарҳо", "Аксессуарҳои мӯд барои мардон ва занон дар канори маҳсулоти зебоӣ."],
      ["Иловагиҳо", "Витаминҳо, ғизои варзишӣ ва зебоӣ барои тамоми оила."],
    ] },
  ...
  ru: {
    ...
    worlds: { tag: "СЕМЬ МИРОВ", title: "Профессиональный отбор красоты", items: [
      ["Парфюмерия", "Селективная парфюмерия, ароматы для дома и подарки — мужские, женские и унисекс."],
      ["Гигиена и уход", "Уход за лицом, телом, полостью рта и детский, а также бритьё и гигиенические наборы."],
      ["Макияж", "Основы цвета и колористики, отобранные для творчества, исполнения и презентации."],
      ["Волосы", "Уход, стайлинг и окрашивание — от салонного до повседневного."],
      ["Техника", "Машинки, фены, стайлеры и приборы для персонального ухода."],
      ["Аксессуары", "Модные аксессуары для мужчин и женщин рядом с бьюти-ассортиментом."],
      ["Добавки", "Витамины, спортивное и бьюти-питание для всей семьи."],
    ] },
  ...
  en: {
    ...
    worlds: { tag: "SEVEN WORLDS", title: "The professional beauty edit", items: [
      ["Fragrance", "Fine fragrance, home scent and gifting, across men's, women's and unisex."],
      ["Personal care", "Face, body, oral and baby care, plus shaving and hygiene sets."],
      ["Makeup", "Colour and complexion essentials selected for artistry, performance and presentation."],
      ["Hair", "Care, styling and colour, from salon-professional to everyday retail."],
      ["Electricals", "Clippers, dryers, styling irons and personal-care devices."],
      ["Accessories", "Fashion accessories for men and women alongside the beauty range."],
      ["Supplements", "Vitamins, sports and beauty nutrition for the whole household."],
    ] },
  ...
  fa: {
    ...
    worlds: { tag: "هفت دنیا", title: "منتخب حرفه‌ای زیبایی", items: [
      ["عطر", "عطر اصل، رایحه خانه و ست هدیه — مردانه، زنانه و مشترک."],
      ["بهداشتی", "مراقبت صورت، بدن، دهان و کودک، به‌همراه اصلاح و ست‌های بهداشتی."],
      ["آرایشی", "اصول رنگ و فرم صورت، منتخب برای هنر، اجرا و ارائه."],
      ["مو", "مراقبت، حالت‌دهی و رنگ — از حرفه‌ای سالن تا مصرف روزمره."],
      ["لوازم برقی", "ماشین اصلاح، سشوار، اتو مو و دستگاه‌های مراقبت شخصی."],
      ["مد و اکسسوری", "اکسسوری مردانه و زنانه در کنار مجموعه زیبایی."],
      ["مکمل", "ویتامین و مکمل ورزشی و زیبایی برای همه‌ی خانواده."],
    ] },
...
export default async function BeautyAboutPage(props) {
  const params = await props.params;
  const { lang } = params;
  const t = getBeautyTranslations(lang);
  const c = COPY[lang] || COPY.en;
